...
namespace BizLogic.Reports
{
    public class GenerateReport1
    {
        ...
        public object GenerateReport(int year, string tipoPlan, IEnumerable<UnidadOrganizativa> uos, IEnumerable<Inmueble> inmuebles)
        {
            var report = new
            {
                               ...
                               inmuebles = from inm in inmuebles
                                           ...
                                           select new
                                           {
                                               ...
                                               objetos = from obj in inm.ObjetosDeObra
                                                         ...
                                                         {
                                                             nombre = obj.Nombre,
                                                             especialidades = from esp in _context.Especialidades
                                                                              select new
                                                                              {
                                                                                  nombre = esp.Tipo,
